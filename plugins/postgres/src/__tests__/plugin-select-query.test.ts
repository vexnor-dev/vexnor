...
describe("VexnorPostgres.newSelectQuery", () => {
   const plugin = new VexnorPostgres();

   test("uses the existing PostgreSQL select command for runtime table reads", () => {
   ...
   test("uses the existing PostgreSQL select command for runtime joins", () => {
