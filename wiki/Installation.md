...
```bash
# Using npx (npm)
npx valnor generate --driver pg --cli one_sql --uri $POSTGRES_URI --outDir 'src/codegen'

# Using pnpm
pnpm dlx valnor generate --driver pg --cli one_sql --uri $POSTGRES_URI --outDir 'src/codegen'
```
