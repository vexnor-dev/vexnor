...
/**
 * Converts a drizzle-orm MSSQL view definition into a valnor runtime table (select-only).
 *
 ...
 * import { fromDrizzleView } from 'valnor-drizzle/mssql';
 *
 * const accountOrderSummary = mssqlSchema('valnor_test')
