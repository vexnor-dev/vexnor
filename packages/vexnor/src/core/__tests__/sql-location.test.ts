...
describe("parseCallerLocation — browser (Vite/@fs)", () => {
   ...
   test("CRUD select — subquery via jsonOne charm", () => {
      const stack = [
         ...
         "    at new SqlQuery (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor/dist/core/query/sql-query.js:71:23)",
         "    at sql (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor/dist/core/sql.js:33:19)",
         "    at http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/charms/json-aggregation-postgres.js:96:29",
         "    at Cache.get (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor/dist/lib/cache.js:10:23)",
         "    at jsonOne (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/charms/json-aggregation-postgres.js:94:18)",
         "    at http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/crud/postgres-select.js:13:85",
         "    at Array.map (<anonymous>)",
         "    at postgresSelect (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/crud/postgres-select.js:13:51)",
   ...
   test("CRUD select — sql`` inside postgresSelect", () => {
      const stack = [
         ...
         "    at new SqlQuery (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor/dist/core/query/sql-query.js:71:23)",
         "    at sql (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor/dist/core/sql.js:33:19)",
         "    at postgresSelect (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/crud/postgres-select.js:21:33)",
         "    at handler.select (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/crud/postgres-table-handler.js:62:36)",
         "    at http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/examples/react-vite-api/shared/queries/postgres.ts:20:48",
      ].join("\n");
      expect(parseCallerLocation(stack, INTERNAL_URL_BROWSER)).toMatchInlineSnapshot(`
   ...
   test("CRUD select — PostgresQueryHandler construction", () => {
      const stack = [
         ...
         "    at new PostgresQueryHandler (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/postgres-query-handler.js:13:9)",
         "    at Proxy.get (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/postgres-augment.js:6:35)",
         ...
         "    at postgresSelect (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/crud/postgres-select.js:27:6)",
         "    at handler.select (http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/dist/crud/postgres-table-handler.js:62:36)",
         "    at http://localhost:5173/@fs/Users/adrian/Work/vexnor-dev/examples/react-vite-api/shared/queries/postgres.ts:20:48",
      ].join("\n");
      expect(parseCallerLocation(stack, INTERNAL_URL_BROWSER)).toMatchInlineSnapshot(`
...
describe("parseCallerLocation — server (Node/tsx src)", () => {
   ...
   test("CRUD select factory at module load", () => {
      const stack = [
         ...
         "    at new PostgresQueryHandler (/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/src/postgres-query-handler.ts:40:7)",
         "    at Proxy.get (/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/src/postgres-augment.ts:23:33)",
         "    at Reflect.get (<anonymous>)",
         "    at Object.get (/Users/adrian/Work/vexnor-dev/packages/vexnor/src/core/query/sql-query.ts:727:53)",
         "    at postgresSelect (/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/src/crud/postgres-select.ts:56:6)",
         "    at Object.handler.select (/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/src/crud/postgres-table-handler.ts:156:10)",
   ...
   test("via sql-select-value Object.as", () => {
      const stack = [
         ...
         "    at <anonymous> (/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/src/schema/find-enums.ts:14:39)",
         "    at ModuleJob.run (node:internal/modules/esm/module_job:343:25)",
         "    at async asyncRunEntryPointWithESMLoader (node:internal/modules/run_main:117:5)",
      ].join("\n");
   ...
   test("registry.execute constructs handler at request time — points to server handler", () => {
      const stack = [
         ...
         "    at new SqlQueryHandler (/Users/adrian/Work/vexnor-dev/packages/vexnor/src/core/query/sql-query-handler.ts:26:7)",
         "    at new PostgresQueryHandler (/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/src/postgres-query-handler.ts:40:7)",
         "    at VexnorPostgres.newQueryHandler (/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/src/vexnor-postgres.ts:104:14)",
   ...
   test("returns null when all non-node frames are internal", () => {
      const stack = [
         ...
         "    at new SqlQuery (/Users/adrian/Work/vexnor-dev/packages/vexnor/src/core/query/sql-query.ts:104:21)",
         "    at sql (/Users/adrian/Work/vexnor-dev/packages/vexnor/src/core/sql.ts:45:18)",
         "    at JsonAggregationPostgres.write (/Users/adrian/Work/vexnor-dev/packages/vexnor-postgres/src/charms/json-aggregation-postgres.ts:69:30)",
