      ...
      expect(await client.callTool({ name: "getSchema", arguments: {} })).toMatchInlineSnapshot(`
        {
          "content": [
            {
              "text": "{"catalog":{"formatVersion":1,"fingerprint":"dba650e84e87ac298507c15b3c656504481019d684828d3939d9d200ddd7d475"},"plugin":{"name":"@vexnor/mcp-test","version":"1.0.0","driver":"test","dialect":"sql"},"warnings":[],"schemas":[{"name":"alpha","objects":[{"id":"alpha.record","schema":"alpha","name":"record","kind":"table","mappingName":"Record","capabilities":{"readable":true,"insertable":false,"updatable":false,"deletable":false,"stableIdentity":true,"automaticJoin":false},"limitations":["mutations-disabled","no-known-selected-relationship"],"query":{"objectIds":["alpha.record"],"name":"read_alpha_record","plugin":"@vexnor/mcp-test","hash":"4817c64a52f660477ddd7cc521b5b64d05f3594781e4d284dbd381203b6fdfa0","columns":["record_id"],"kind":"read"}}]}]}",
              "type": "text",
            },
          ],
          "structuredContent": {
            "catalog": {
              "fingerprint": "dba650e84e87ac298507c15b3c656504481019d684828d3939d9d200ddd7d475",
              "formatVersion": 1,
            },
            "plugin": {
              "dialect": "sql",
