      ...
      tables: [
         {
            ...
            columns: [
               ...
               column({
                  ...
                  is_updatable: "NO",
                  is_generated: "ALWAYS",
                  generation_expression: "synthetic_expression",
               }),
            ],
            primary_keys: [
               {
                  constraint_name: "pk_line_item",
                  table_schema: "beta",
                  table_name: "line_item",
                  column_name: "parent_id",
                  ordinal_position: 2,
            ...
            foreign_keys: [
               {
                  constraint_name: "fk_line_item_parent",
                  table_schema: "beta",
                  table_name: "line_item",
                  column_name: "parent_id",
                  referenced_table_schema: "alpha",
                  referenced_table_name: "parent_record",
               ...
               },
               {
                  ...
                  referenced_table_schema: "alpha",
                  referenced_table_name: "parent_record",
                  referenced_column_name: "sequence_no",
                  ordinal_position: 1,
               },
            ],
         },
         {
            ...
            columns: [
               ...
               column({
                  table_name: "parent_record",
                  column_name: "state",
                  udt_name: "synthetic_state",
                  data_type: "USER-DEFINED",
                  ordinal_position: 3,
                  column_default: "'queued'",
               }),
            ],
            primary_keys: [
               {
                  constraint_name: "pk_parent_record",
                  table_schema: "alpha",
                  table_name: "parent_record",
                  column_name: "parent_id",
                  ordinal_position: 1,
...
describe("createSchemaCatalog", () => {
      ...
      expect(catalog).toMatchInlineSnapshot(`
        {
          ...
          "fingerprint": "baab87858dc7aa8286772c403da0ec97d447957f2efc141df8dce34d44fae251",
          "formatVersion": 1,
          "objects": [
            {
              "capabilities": {
   ...
   test("rejects duplicate object and column identities", () => {
      ...
      expect(() => createSchemaCatalog({ plugin, schema: duplicateObject })).toThrowErrorMatchingInlineSnapshot(
         `[Error: Duplicate schema object identity: beta.line_item]`,
      );

      const duplicateColumn = schema();
      duplicateColumn.tables[0]!.columns.push(duplicateColumn.tables[0]!.columns[0]!);

      expect(() => createSchemaCatalog({ plugin, schema: duplicateColumn })).toThrowErrorMatchingInlineSnapshot(
         `[Error: Duplicate column in beta.line_item identity: parent_id]`,
      );

      const duplicateEnum = schema();
      duplicateEnum.enums.push(duplicateEnum.enums[0]!);
      expect(() => createSchemaCatalog({ plugin, schema: duplicateEnum })).toThrowErrorMatchingInlineSnapshot(
         `[Error: Duplicate schema enum identity: alpha.synthetic_state]`,
      );

      const conflictingPrimaryKeys = schema();
      conflictingPrimaryKeys.tables[0]!.primary_keys[1]!.constraint_name = "pk_line_item_other";
      expect(() => createSchemaCatalog({ plugin, schema: conflictingPrimaryKeys })).toThrowErrorMatchingInlineSnapshot(
         `[Error: Expected one primary-key constraint, received: pk_line_item, pk_line_item_other]`,
      );
   });
                  ...
                  foreign_keys: [
                     {
                        ...
                        referenced_column_name: "right_id",
                        ordinal_position: 1,
                     },
                     {
                        table_schema: "beta",
                        ...
                        referenced_table_schema: "alpha",
                        referenced_table_name: "target",
                        referenced_column_name: "left_id",
                        ordinal_position: 1,
                     },
                  ],
               },
